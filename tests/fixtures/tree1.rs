        ...
        I: Iterator<Item = toql::query::field_path::FieldPath<'a>>,
    {
        match descendents.next() {
            Some(d) => match d.as_str() {
                ...
                "gamma" => Ok(<Gamma as toql::tree::tree_identity::TreeIdentity>::auto_id(
                    &mut descendents,
                )?),
                f @ _ => {
...
impl toql::tree::tree_identity::TreeIdentity for &mut Gamma {
    ...
    where
        I: Iterator<Item = toql::query::field_path::FieldPath<'a>>,
    {
        <Gamma as toql::tree::tree_identity::TreeIdentity>::auto_id(descendents)
    }
    #[allow(unused_mut)]
    fn set_id<'a, 'b, I>(
        &mut self,
...
impl toql::table_mapper::mapped::Mapped for Gamma {
    fn type_name() -> String {
        String::from("Gamma")
    }
    fn table_name() -> String {
...
impl toql::table_mapper::mapped::Mapped for &Gamma {
    fn type_name() -> String {
        <Gamma as toql::table_mapper::mapped::Mapped>::type_name()
    }
    fn table_name() -> String {
        <Gamma as toql::table_mapper::mapped::Mapped>::table_name()
    }
    fn table_alias() -> String {
        <Gamma as toql::table_mapper::mapped::Mapped>::table_alias()
    }
    fn map(mapper: &mut toql::table_mapper::TableMapper) -> toql::result::Result<()> {
        <Gamma as toql::table_mapper::mapped::Mapped>::map(mapper)
    }
}
impl toql::table_mapper::mapped::Mapped for &mut Gamma {
    fn type_name() -> String {
        <Gamma as toql::table_mapper::mapped::Mapped>::type_name()
    }
    fn table_name() -> String {
